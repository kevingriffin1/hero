...
from ..errors import HeroRetryError, task_engine_exceptions
from .. import errors
...
@retry(
    ...
    wait=wait_fixed(1),
    reraise=True,
    retry=task_engine_exceptions,
)
def task_engine_handle_exceptions(self, func, *args, **kwargs):
...
def retry_method(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        try:
            local_instance = task_engine_handle_exceptions.retry_with(
