...
class TaskEngineService(ServiceBase):
    ...
    def read_queues(self, task_engine_id):
    ...
    def read_queue(self, task_engine_id, queue_id):
        headers = self.get_headers(self.client.get_token())
    ...
    def read_tasks(self, task_engine_id, queue_id, metatype, state):
        headers = self.get_headers(self.client.get_token())
    ...
    def read_task(self, task_engine_id, task_id):
        headers = self.get_headers(self.client.get_token())
